...
department, planned task, etc...</p>
				...
				<div class="home_featured_products_row row">
					<div class="home_ft_items col-sm-3 col-md-2">
						<a href="#" title="###">
					...
					<div class="home_ft_items hidden-sm col-md-2">
						<a href="#" title="###">
						<div class="home_ft_item">
							<div class="home_ft_item_ft_img">
					...
					<div class="home_ft_items hidden-sm col-md-2">
						...
						<div class="home_ft_item">
							<div class="home_ft_item_ft_img">
								<img src="<?php bloginfo('template_directory');?>/img/dev/06.png" width="127" alt="###" />
							</div>
							<div class="home_ft_item_price_bar">
								<p>only <span class="home_ft_item_price_span">€22.22</span></p>								
							</div>
