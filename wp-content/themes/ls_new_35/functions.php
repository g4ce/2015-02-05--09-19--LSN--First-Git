...
add_action( 'woocommerce_before_single_product_summary','lsn_single_product_enquiry', 40 );
...
/* woocommerce_after_shop_loop_item_title */
add_action('woocommerce_after_shop_loop_item_title','lsn_email_enq_modal', 20);


/** end Woocommerce Hooks / Unhooks */

/** Woocommerce Hooks Functions */
/* Single Product E-mail Enquiry */
function lsn_single_product_enquiry(){

}
/* lsn_start_button_wrap */
function lsn_start_button_wrap(){
  echo '<div class="cat_page_button_wrap">';
}
/* lsn_end_button_wrap */
function lsn_end_button_wrap(){
  echo '</div>';
}
/** end Woocommerce Hooks Functions */

add_filter('widget_text', 'do_shortcode');

/* Display phone number on pages */
