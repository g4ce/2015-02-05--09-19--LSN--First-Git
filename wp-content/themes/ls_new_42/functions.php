...
function change_settings(){
  ...
  <form method="post" action="options.php">  
    ...
    <input type="hidden" name="page_options" value="facebook_link,twitter_link,youtube_link,linkedin_link,is_related,brochure_link,delivery_link,tracking_sales,tracking_enquiries,tracking_emails,tracking_brochures,tracking_mobiles" />  
  </form>  
  <?php
}
...
// woocommerce_after_shop_loop_item_title
add_action('woocommerce_after_shop_loop_item_title','lsn_start_button_wrap', 25);
          //add_action('woocommerce_after_shop_loop_item_title','lsn_single_enquiry', 20);
// woocommerce_after_shop_loop_item
add_action('woocommerce_after_shop_loop_item', 'lsn_end_button_wrap', 25);
...
function lsn_single_enquiry() /* v. 1.00 */{?>
  <button type="submit" class="single_add_to_cart_button button alt cart-buttton add-to-cart" data-toggle="modal" data-target="#lsn_single_enq_modal">Email</button>

  <!-- Modal -->
  <div class="modal fade" id="lsn_single_enq_modal" tabindex="-1" role="dialog" aria-labelledby="lsn_single_enq_modal_label" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="lsn_single_enq_modal_label">Email Enquiry</h4>
        </div>
...
?>
<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#emailEnquiryModal">
Email Enquiry
</button>
          ...
          $term = get_term_by( 'id', $child, $taxonomy_name );
            ...
            <a href="<?php echo get_term_link( $child, $taxonomy_name );?>" title="<?php echo $term->name;?>">
                <div class="col-md-6 sub_cat_display">
                  ...
                  $thumbnail_id = get_woocommerce_term_meta( 13, 'thumbnail_id', true ); 
                  // get the image URL
...
function display_phone() /* v. 1.00 */{
  if (strcmp(get_option('tracking_mobiles'), 'N') == 0) {
     ...
     echo 'CALL <a class="top_call" href="tel:+353578662162">+353 (0) 57 866 2162</a>';
  }
  else
...
/**** 6.4.  Actual Category Email Enquiry */
function get_single_enquiry_line() /* v. 1.03 */{
/*
  ...
  global $product;
        if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
          ...
          <?php if ( $_product->is_visible() ) { ?>
              ...
              <?php $msg .= '<td style="vertical-align: top;">' . $product_name . '</td><td style="vertical-align: top;">'. $product_sku .'</td><td style="vertical-align: top;">1</td><td style="vertical-align: top;">'. $product_price .'</td></tr>';?>
...
<td style="vertical-align: top;">' . $product_price .'
</td>
</tr>
</tbody>
</table>';
...
function wpcf7_add_text_to_mail_body($contact_form) /* v. 1.00 */{
  ...
  if ($id == 46){
    ...
    $add_this = get_single_enquiry_line();
