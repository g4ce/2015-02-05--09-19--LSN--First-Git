...
<tr class="shipping">
	<th><?php
		if ( $show_package_details ) {
			...
			_e( 'Delivery Charge', 'woocommerce' );
		}
	?></th>
			...
			<?php elseif ( get_option( 'woocommerce_shipping_method_format' ) === 'select' ) : ?>
				...
				<select name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>" class="shipping_method">
					<?php foreach ( $available_methods as $method ) : ?>
						<option value="<?php echo esc_attr( $method->id ); ?>" <?php selected( $method->id, $chosen_method ); ?>><?php echo wp_kses_post( lsn_wc_cart_totals_shipping_method_label( $method ) ); ?></option>
					<?php endforeach; ?>
				</select>
				...
				<ul id="shipping_method">
					<?php foreach ( $available_methods as $method ) : ?>
						<li>
							...
							<label for="shipping_method_<?php echo $index; ?>_<?php echo sanitize_title( $method->id ); ?>"></label>
...
function lsn_wc_cart_totals_shipping_method_label( $method ) {
	?>
<!-- function override -->
	<?php
  //$label = $method->label;
