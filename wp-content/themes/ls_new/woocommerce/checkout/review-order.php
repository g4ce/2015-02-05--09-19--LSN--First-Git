...
<?php if ( ! $is_ajax ) : ?><div id="order_review"><?php endif; ?>
	...
	<table class="shop_table">
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<td class="unit-price">
								<?php echo apply_filters( 'woocommerce_cart_item_name', $_product->get_price_html(), $cart_item, $cart_item_key ); ?>
							</td>
		...
		<tfoot>
			...
			<tr class="total_excl_vat">
				<th>Total Cost - excluding VAT</th>
				<td class="table_spacer"></td>
				<td class="table_spacer"></td>
			...
			<tr class="order-total">
				<th><?php _e( 'Total Cost - including VAT', 'woocommerce' ); ?></th>
				<td class="table_spacer"></td>
				<td class="table_spacer"></td>
