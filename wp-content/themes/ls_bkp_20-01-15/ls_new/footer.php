		<footer class="main_footer container">
			...
			<div class="footer_row row">
				...
				<div class="footer_right col-sm-6">
					<div class="footer_right_box">
						...
						Put requrest a brochure contact form here
					</div>
					...
					<div class="footer_right_box bottom_box">
						<div class="bottom_box_small footer_social_media">
							...
							<ul>
								<li class="footer_facebook"><a href="<?php echo get_option('facebook_link');?>" title="Follow Us on Facebook"></a></li>
								<li class="footer_twitter"><a href="<?php echo get_option('twitter_link');?>" title="Follow Us on Twitter"></a></li>
								<li class="footer_youtube"><a href="<?php echo get_option('youtube_link');?>" title="View Our YouTube Channel"></a></li>
								<li class="footer_linkedin"><a href="<?php echo get_option('linkedin_link');?>" title="Follow us on LinkedIn"></a></li>
							</ul>
						</div>
			...
			<!-- end footer row -->
			<div id="copyrights">
				<p>&copy; <?php echo date("Y");?> <?php echo get_bloginfo('name');?>. All Rights Resaved. | <a href="#">Privacy Policy</a>.
			</div>
			<!-- end copyrights -->
